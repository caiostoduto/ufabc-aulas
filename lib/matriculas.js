...
exports.fetchMatriculaURL = exports.fetchMatriculas = void 0;
...
async function fetchMatriculaURL(matriculasURL, anterioresURL) {
    try {
...
exports.fetchMatriculaURL = fetchMatriculaURL;
async function _fetchMatriculaURL(matriculasURL) {
...
async function fetchLatestMatricula(anterioresURL) {
    const anterioresHtml = await (0, utils_1.fetch)(anterioresURL.toString());
